            ...
            <div className="flex flex-col space-y-4 mt-6">
              ...
              {user && (
                <div className="space-y-2 pt-4 border-t">
                  ...
                  <button
                    className="flex items-center space-x-3 text-sm font-medium text-red-600 hover:text-red-700 transition-colors p-2 rounded-md hover:bg-red-50 w-full text-left"
                    onClick={() => signOut({ redirectUrl: "/" })}
                  >
